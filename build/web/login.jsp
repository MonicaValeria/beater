...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        ...
        <div class="collapse navbar-collapse text-right justify-content-end" id="navbar2SupportedContent">           
            <a href="beater.jsp"class="btn navbar-btn ml-2 text-white btn-secondary">Volver</a>
        </div>
    </div>
</nav>
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form name="formlogin" action="ServletLogin" method="post">
      <div class="form-group has-feedback">
        <input class="form-control" id="user" name="user" placeholder="Usuario">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" id="pass" name="pass" placeholder="Contraseña">
        <a href="login_password.jsp"class="btn navbar-btn ml-2 text-white btn-secondary">¿Olvidaste tu contraseña?</a>
