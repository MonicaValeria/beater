...
<div class="modal-content">
        ...
        <div class="modal-body">
             <form name="formregistro" action="ServletCreateLocal" method="post" id="loginForm">
               <div class="form-group">                   
                 </div>
                 <input type="hidden" class="form-control" id="id" name="id" value="<%=id%>">
                 <div class="form-group">
                    <label>Nombre del local:</label>
                    <input type="text" class="form-control" placeholder="Ingrese nombre del local" id="nom_lo" name="nom_lo">                   
                 </div>
                  <div class="form-group">
                    <label>Dirección:</label>
                    <input type="text" class="form-control" placeholder="Ingrese dirección" id="add" name="add">
                  </div>
                  <div class="form-group">
                    <label>Referencia:</label>
                    <input type="text" class="form-control" placeholder="Ingrese una referencia" id="ref" name="ref">                                    
                  </div>
                  <div class="form-group">
                    <label>Telefono:</label>
                    <input type="text" class="form-control" placeholder="Ingrese un telefono fijo o móvil" id="telf" name="telf">                                    
                  </div>
...
<div class="box-body">
    ...
    <div class="col-md-12 callout callout-warning">
        <div class="col-md-9">
          <h4>Nombre del local: <%out.println(lo.getName_local());%></h4>
          <table id="example2" class="table">
          <%out.println("<tbody><tr>");%>                    
          <%out.println("<td>Direccion: "+lo.getAddress()+"</td>");%>
          <%out.println("<td>Referencia: "+lo.getReference()+"</td>");%>
          <%out.println("<td>Telefono: "+lo.getTelefono()+"</td>");%>
          <%out.println("<td>Dias: "+lo.getDias()+"</td>");%>
          <%out.println("<td>"
                  + "Hora de inicio: "+lo.getHorario_inicio()+"</td>");%>
          <%out.println("<td>Hora de fin: "+lo.getHorario_fin()+"</td>");%>
        ...
        <div class="col-md-3">
            ...
            <div class="column mt-2">  
                <%out.println("<a style='text-decoration:none' class='btn btn-primary btn-block btn-responsive' "
                        + "href='ServletRedirec?id_local="+String.valueOf(lo.getId_local())+"'>Editar</a>");%>
            </div>
            <br>

            <div class="column mt-2">  
                <%out.println("<a style='text-decoration:none' class='btn btn-primary btn-block btn-responsive' "
                        + "href='ServletDeleteLocalById?id_local="+String.valueOf(lo.getId_local())+"'>Eliminar</a>");%>
            </div>
