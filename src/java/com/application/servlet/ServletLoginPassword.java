...
public class ServletLoginPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            try {
                ...
                boolean password = pdao.DAOPersonLoginPassword(de, clave, para, mensaje, asunto);
                
                if(password){
                    //SWAL ALERT
                    Alert alert = new Alert();
                    String titulo = "¡!";
                    String msg = "Se ha enviado su usuario y contraseña a su correo";
                    String tipo = "success";   // "error" "success" "warning" and "info".
                ...
                System.out.println("ServletLoginPassword Failed "+e.getMessage());
                destino = "beater.jsp";
