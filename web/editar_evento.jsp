<%-- 
    ...
    Created on : 30-may-2018, 0:59:04
    Author     : Monica
--%>
...
<%  int id_ev = (Integer) session.getAttribute("id_ev");
    int id = (Integer) session.getAttribute("id");
    String nom_ev = (String) session.getAttribute("nom_ev");
    String dia_ini_ev = (String) session.getAttribute("dia_ini_ev");
    String dia_fin_ev = (String) session.getAttribute("dia_fin_ev");
    String hora_ini_ev = (String) session.getAttribute("hora_ini_ev");
    String hora_fin_ev = (String) session.getAttribute("hora_fin_ev");
    int id_local = (Integer) session.getAttribute("id_local");
    int id_gm = (Integer) session.getAttribute("id_gm");
...
<div class="wrapper">
 ...
 <!-- Profile Image -->
        ...
        <div class="box box-primary">
            ...
            <form class="form-horizontal" id="reg_form" name="formregistro" action="ServletUpdateEventById" method="post">                
              <div class="box-body">
                   
          
                <input type="hidden" class="form-control" id="id_ev" name="id_ev" value="<%=id_ev%>">
                <input type="hidden" class="form-control" id="id_local" name="id_local" value="<%=id_local%>">
                <input type="hidden" class="form-control" id="id_gm" name="id_gm" value="<%=id_gm%>">
                <input type="hidden" class="form-control" id="id" name="id" value="<%=id%>">
                <div class="form-group">
                  <label  class="col-sm-2 control-label">Nombre del evento:</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="nom_ev" name="nom_ev" value="<%=nom_ev%>" >
                  </div>
                </div>                 
                <div class="form-group">
