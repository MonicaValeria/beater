<%-- 
    Document   : local_registrar
    Created on : 15-may-2018, 17:33:57
    Author     : Monica
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <% int id_contractor = (Integer) session.getAttribute("id_contractor"); %>
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="#"><b>REGISTRAR LOCAL | BEATER</b></a>
            ...
            <div class="col-md-6" id="book">
                <div class="card">
                    <div class="card text-white p-5 bg-dark">
                        <div class="card-body">
                            <h2 class="mb-4" contenteditable="true">Crear Local</h2>
                            <form name="formregistro" action="ServletCreateLocal" method="post">
                               
                                
                                    
                                <div class="form-group">
                                    
                                    <input type="text" class="form-control" placeholder="Ingrese nombre del local" id="id_contractor" name="id_contractor" value="<%=id_contractor%>">
                                 </div>
                                 <div class="form-group">
                                  ...
                                  <div class="form-group align-center">
                                    <ibuttonput class="btn btn-info" type="reset" value="Borrar Información">
